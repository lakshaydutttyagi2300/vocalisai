...
export const PRACTICE_MODES: PracticeModeDef[] = [
  ...
  },
  {
    ...
    category: "VOCABULARY",
    label: "Vocabulary",
    description: "Everyday, academic and professional vocabulary, meaning and usage.",
    questionType: "MULTIPLE_CHOICE",
    requiresVoice: false,
  },
  {
  ...
  },
  {
    ...
    description: "Realistic workplace and everyday scenarios - choose the best course of action.",
    questionType: "MULTIPLE_CHOICE",
    requiresVoice: false,
  },
  {
    ...
    description: "Practice written responses to common job interview questions.",
